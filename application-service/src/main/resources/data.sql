...
SELECT * FROM (
                  ...
                  UNION ALL
                  SELECT 'a1e45678-1111-4a4d-aaaa-123456789007'::UUID, 'IN_REVIEW', 'b1e45678-1111-4a4d-bbbb-123456789017'::UUID, 'Awaiting client feedback', '2025-06-09'::DATE, 'a6dcb473-bee8-47c6-be62-1021f4597c63'::UUID, '2025-06-10'::DATE, 'c1e45678-1111-4a4d-cccc-123456789027'::UUID
                  UNION ALL
                  SELECT 'a1e45678-1111-4a4d-aaaa-123456789008'::UUID, 'REJECTED', 'b1e45678-1111-4a4d-bbbb-123456789018'::UUID, 'Job closed', '2025-06-08'::DATE, 'a6dcb473-bee8-47c6-be62-1021f4597c63'::UUID, '2025-06-09'::DATE, 'c1e45678-1111-4a4d-cccc-123456789028'::UUID
                  UNION ALL
                  SELECT 'a1e45678-1111-4a4d-aaaa-123456789009'::UUID, 'APPROVED', 'b1e45678-1111-4a4d-bbbb-123456789019'::UUID, 'Confirmed via call', '2025-06-07'::DATE, 'a6dcb473-bee8-47c6-be62-1021f4597c63'::UUID, '2025-06-08'::DATE, 'c1e45678-1111-4a4d-cccc-123456789029'::UUID
                  UNION ALL
                  SELECT 'a1e45678-1111-4a4d-aaaa-123456789010'::UUID, 'PENDING', 'b1e45678-1111-4a4d-bbbb-123456789020'::UUID, 'Application in queue', '2025-06-06'::DATE, 'a6dcb473-bee8-47c6-be62-1021f4597c63'::UUID, '2025-06-07'::DATE, 'c1e45678-1111-4a4d-cccc-123456789030'::UUID
              ) AS data
WHERE NOT EXISTS (
